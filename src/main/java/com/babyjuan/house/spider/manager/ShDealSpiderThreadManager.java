package com.babyjuan.house.spider.manager;
 ...
 */
@Service
public class ShDealSpiderThreadManager {

    private static final Logger LOGGER = LoggerFactory.getLogger(ShDealSpiderThreadManager.class);
